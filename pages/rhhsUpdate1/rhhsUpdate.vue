		...
		<scroll-view :style="{height:scrollerHeight}" show-scrollbar='false' scroll-y="true" class="main" ref='main'>
			<view class="gs_title">
				<view class="">
					...
					<text style="color:#fff;opacity: .8; font-size: 25rpx;">农户属性:脱贫户</text>
				</view>
				<text class="editBtn" @click="editIpt()">编辑</text>
			</view>
			<view class="gs_list">
				<view class="gs_item">
					<text class="gs_left">农户类型:</text>
					<text class="gs_right">脱贫户</text>
				</view> 
				<view class="gs_item">
					<text class="gs_left">申请年度:</text>
				...
				<view class="gs_item">
					<text class="gs_left">近一年家庭年均可支配收入(元):</text>
					<view class="gs_right">
						<input type="text" :disabled="!hsbool"  class="ipt" value="" placeholder="请输入" />
					</view>
				</view> 
				<view class="gs_item">
					<text class="gs_left">申请帮扶原因:</text>
					<view class="gs_right">因贫,因病</view>
				</view>
				 <view class="gs_item" v-if="hsbool" style="display: block;height: auto;">
