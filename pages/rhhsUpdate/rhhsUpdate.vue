<template>
	<view class="" style="background: #FAFAFA;width: 100vw;height: 100vh;" id="wrap">
		<uni-header1 :title="title" id='header'>
			<icon class="iconfont iconzuojiantou" slot="header_left" style="font-size: 48rpx;color: #333;" @click="back"></icon>
		</uni-header1>
		<scroll-view :style="{height:scrollerHeight}" show-scrollbar='false' scroll-y="true" class="main" ref='main'>
			...
			<view class="table">
				...
				<view class="edit_box" style="width: 100%;font-size: 30rpx;color: rgb(59, 143, 242);height: 100rpx;display: flex;justify-content: center;align-items: center;">
					<!-- <image src="../../static/img/edit.png" mode="" style="margin-right: 6rpx;width: 50rpx;height: 50rpx;"></image>编辑信息 -->
			...
			<view class="uploads_box">
				<view class="upload_h3">
					致贫事项描述及佐证材料<text style="color: red; margin: 0px 10rpx;">*</text>
				</view>
				<view id="fileText">
					<textarea name="" id="fileTextArea" placeholder="请写下您的致贫事项描述"  maxlength="500"></textarea>
			...
			<view class="report_list" style="margin-bottom: 20rpx;padding: 20rpx 30rpx;background: #fff;margin-top: 20rpx;">
...
<style scoped lang="scss">
	...
	.add_farm{
		...
		text-align: center;
		line-height: 88rpx;
		border: 1px solid rgba(87, 107, 222, 1);
	    box-sizing: border-box;
