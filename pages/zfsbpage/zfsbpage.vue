<template>
	<view class="login">
		...
		<view class="button-box">
			<button type="default" style="background: #00B65A;" class="login-btn" @click="login()">查询</button>
		</view> 
		<view class="button-box">
			<button type="default" style="background: #1D92F1;" class="login-btn" @click="login()">历史记录</button>
		</view> 
	</view>
</template>
